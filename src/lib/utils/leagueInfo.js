/*   STEP 1   */
export const leagueID = "845360483279147008"; // your league ID
export const leagueName = "The Dynasty League (DLF)"; // your league name
...
export const homepageText = `
 Testing out creating a website for our league
`;
...
export const managers = [
     {
       ...
       "rival": {
         name: "The World", // Can be anything (usually your rival's name)
